...
import com.david.NUTRITION_TRACNKER.dto.ShoppingListItemDTO;
...
public class EmailService {
    ...
    public void sendRangeShoppingListEmail(User user, ShoppingList list, Map<String, List<ShoppingListItemDTO>> groupedItems) throws Exception {
