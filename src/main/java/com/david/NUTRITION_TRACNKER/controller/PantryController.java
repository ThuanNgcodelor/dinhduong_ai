...
import org.springframework.web.bind.annotation.GetMapping; // Import Session
...
import com.david.NUTRITION_TRACNKER.service.PantryService;
...
public class PantryController {
    ...
    public String viewAiRecipeDetail(@PathVariable int index, HttpSession session, Model model) {
        ...
        model.addAttribute("backLabel", "Quay lại Tủ Lạnh");
